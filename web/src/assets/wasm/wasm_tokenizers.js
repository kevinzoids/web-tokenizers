...
export class Token {
     ...
     */
    get tokens() {
        const ret = wasm.token_get_tokens(this.__wbg_ptr);
     ...
     */
    get inputIds() {
        const ret = wasm.token_get_ids(this.__wbg_ptr);
     ...
     */
    get attentionMask() {
        const ret = wasm.token_get_attention_mask(this.__wbg_ptr);
        var v1 = getArrayU32FromWasm0(ret[0], ret[1]).slice();
        wasm.__wbindgen_free(ret[0], ret[1] * 4, 4);
        return v1;
    }
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('wasm_tokenizers_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
